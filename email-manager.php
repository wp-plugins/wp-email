...
?>
<ul id="adminmenu2"> 
	<li><a href="email-manager.php" class="current"><?php _e('Manage E-Mail'); ?></a></li> 
	<li class="last"><a href="email-options.php"><?php _e('E-Mail Options'); ?></a></li>
</ul>
	...
	<?php
		if($email_logs) {
			...
			foreach($email_logs as $email_log) {
				...
				$email_date = date("jS F Y", $email_log->email_timestamp);
				$email_time = date("H:i", $email_log->email_timestamp);
