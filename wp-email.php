...
function email_js() {
	...
	echo '/* <![CDATA[ */'."\n";
	echo "\t".'var email_ajax_url = \''.get_option('siteurl').'/wp-content/plugins/wp-email/wp-email.php'."';\n";
	echo "\t".'var email_max_allowed = \''.$email_max.'\';'."\n";
	echo "\t".'var email_verify = \''.$_SESSION['email_verify'].'\';'."\n";
	echo "\t".'var email_text_error = \''.__('The Following Error Occurs:', 'wp-email').'\';'."\n";
	echo "\t".'var email_text_name_invalid = \''.__('- Your Name is empty/invalid', 'wp-email').'\';'."\n";
	echo "\t".'var email_text_email_invalid = \''.__('- Your Email is empty/invalid', 'wp-email').'\';'."\n";
	echo "\t".'var email_text_remarks_invalid = \''.__('- Your Remarks is invalid', 'wp-email').'\';'."\n";
	echo "\t".'var email_text_friend_names_empty = \''.__('- Friend Name(s) is empty', 'wp-email').'\';'."\n";
	echo "\t".'var email_text_friend_name_invalid = \''.__('- Friend Name is empty/invalid:', 'wp-email').'\';'."\n";
	echo "\t".'var email_text_max_friend_names_allowed = \''.sprintf(__('- Maximum %s Friend Name(s) allowed', 'wp-email'), $email_max).'\';'."\n";
	echo "\t".'var email_text_friend_emails_empty = \''.__('- Friend Email(s) is empty', 'wp-email').'\';'."\n";
	echo "\t".'var email_text_friend_email_invalid = \''.__('- Friend Email is invalid:', 'wp-email').'\';'."\n";
	echo "\t".'var email_text_max_friend_emails_allowed = \''.sprintf(__('- Maximum %s Friend Email(s) allowed', 'wp-email'), $email_max).'\';'."\n";
	echo "\t".'var email_text_friends_tally = \''.__('- Friend Name(s) count does not tally with Friend Email(s) count', 'wp-email').'\';'."\n";
	echo "\t".'var email_text_image_verify_empty = \''.__('- Image Verification is empty', 'wp-email').'\';'."\n";
	echo '/* ]]> */'."\n";
	echo '</script>'."\n";
