...
### Function: Enqueue E-Mail Stylesheets
add_action('wp_print_styles', 'email_stylesheets');
function email_stylesheets() {
...
function email_javascripts() {
	...
	echo "\n".'<!-- Start Of Script Generated By WP-EMail 2.50 -->'."\n";
	wp_print_scripts('wp-email');
	echo '<!-- End Of Script Generated By WP-EMail 2.50 -->'."\n";
}
