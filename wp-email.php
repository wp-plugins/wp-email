				...
				<?php while (have_posts()) : the_post(); ?>
					<?php if(not_password_protected()) { ?>
						...
						<p>
							...
							<input type="text" size="50" maxlength="100" name="friendname" class="Forms" /><?php email_multiple(); ?></i>
						</p>
						<p>
							<b>Friend's E-Mail: *</b><br />
							<input type="text" size="50" maxlength="100" name="friendemail" class="Forms" /><?php email_multiple(); ?></i>
						</p>
						<p align="center">
