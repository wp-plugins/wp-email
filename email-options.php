...
if($_POST['Submit']) {
	...
	$email_options = array();
	$email_options['post_text'] = addslashes(trim(wp_filter_kses($_POST['email_post_text'])));
	$email_options['page_text'] = addslashes(trim(wp_filter_kses($_POST['email_page_text'])));
	...
	$email_template_title = trim(wp_filter_kses($_POST['email_template_title']));
	$email_template_subtitle = trim(wp_filter_kses($_POST['email_template_subtitle']));
	$email_template_subject = strip_tags(trim($_POST['email_template_subject']));
	$email_template_body = trim(wp_filter_kses($_POST['email_template_body']));
	$email_template_bodyalt = trim(wp_filter_kses($_POST['email_template_bodyalt']));
	$email_template_sentsuccess = trim(wp_filter_kses($_POST['email_template_sentsuccess']));
	$email_template_sentfailed = trim(wp_filter_kses($_POST['email_template_sentfailed']));
	$email_template_error = trim(wp_filter_kses($_POST['email_template_error']));
