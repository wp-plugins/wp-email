...
$this_file = $parent_file = 'email-options.php';
$id = intval($_GET['id']);
$standalone = 0;
...
<ul id="adminmenu2"> 
	<li><a href="email-manager.php"><?php _e('Manage E-Mail'); ?></a></li> 
	<li class="last"><a href="email-options.php"  class="current"><?php _e('E-Mail Options'); ?></a></li>
</ul>
...
<div class="wrap"> 
	...
	<form name="email_options" method="post" action="email-options.php"> 
		<fieldset class="options">
			<legend><?php _e('SMTP Information'); ?></legend>
			<?php
		...
		<fieldset class="options">
			<legend><?php _e('PHP Mailer Information'); ?></legend>
			<table width="100%" cellspacing="2" cellpadding="5" class="editform"> 
				 <tr valign="top">
		...
		<fieldset class="options">
			...
			<table width="100%" cellspacing="2" cellpadding="5" class="editform"> 
				 <tr valign="top">
					...
					<td width="70%" align="left"><input type="text" id="email_template_subject" name="email_template_subject" value="<?php echo stripslashes(get_settings('email_template_subject')); ?>" size="120" /></td>
				</tr>
				<tr valign="top"> 
					<td width="30%" align="left">
					...
					<td width="70%" align="right"><textarea cols="100" rows="15" id="email_template_body" name="email_template_body"><?php echo stripslashes(get_settings('email_template_body')); ?></textarea></td> 
				</tr>
				<tr valign="top"> 
					<td width="30%" align="left">
					...
					<td width="70%" align="right"><textarea cols="100" rows="15" id="email_template_bodyalt" name="email_template_bodyalt"><?php echo stripslashes(get_settings('email_template_bodyalt')); ?></textarea></td> 
				</tr>
			</table>
		</fieldset>
		<fieldset class="options">
			...
			<table width="100%" cellspacing="2" cellpadding="5" class="editform"> 
				 <tr valign="top">
					...
					<td width="70%" align="right"><textarea cols="100" rows="10" id="email_template_sentsuccess" name="email_template_sentsuccess"><?php echo stripslashes(get_settings('email_template_sentsuccess')); ?></textarea></td>
				</tr>
				<tr valign="top"> 
					<td width="30%" align="left">
					...
					<td width="70%" align="right"><textarea cols="100" rows="10" id="email_template_sentfailed" name="email_template_sentfailed"><?php echo stripslashes(get_settings('email_template_sentfailed')); ?></textarea></td> 
				</tr>
			</table>
		</fieldset>
		<fieldset class="options">
			...
			<table width="100%" cellspacing="2" cellpadding="5" class="editform"> 
				 <tr valign="top">
					...
					<td width="70%" align="right"><textarea cols="100" rows="10" id="email_template_error" name="email_template_error"><?php echo stripslashes(get_settings('email_template_error')); ?></textarea></td>
				</tr>
			</table>
		</fieldset>
		<p class="submit"> 
