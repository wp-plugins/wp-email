...
function email_popup($text_post = 'Email This Post', $text_page = 'EMail This Page') {
	global $id;
	if(is_page()) {
		echo '<a href="'.get_settings('home').'/wp-email-popup.php?page_id='.$id.'" onclick="email_popup(this.href); return false">'.$text_page.'</a>';
	} else {
		echo '<a href="'.get_settings('home').'/wp-email-popup.php?p='.$id.'" onclick="email_popup(this.href); return false">'.$text_post.'</a>';
	}
}
...
function email_popup_image() {
	...
	if(is_page()) {
		echo '<a href="'.get_settings('home').'/wp-email-popup.php?page_id='.$id.'" onclick="email_popup(this.href); return false">'.$email_image.'</a>';
	} else {
		echo '<a href="'.get_settings('home').'/wp-email-popup.php?p='.$id.'" onclick="email_popup(this.href); return false");>'.$email_image.'</a>';
	}
}
